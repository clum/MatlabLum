...
%DIR2   Adds funtionality to the dir command
%
%   [FILES] = DIR2(DIRNAME) returns the same as DIR(DIRNAME)
%
%   [...] = DIR2(DIRNAME, 'only_files') does as above but only returns a list
%   of file names in the directory DIRNAME. Folders names in this folder
